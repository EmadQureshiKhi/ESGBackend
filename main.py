...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:5173", "http://localhost:3000", "https://kpmgesg.vercel.app", "https://*.vercel.app", "https://www.kpmgesgtool.xyz", "https://kpmgesgtool.xyz"],  # Vite dev server
